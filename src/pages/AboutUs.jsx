  ...
  <div className="grid md:grid-cols-[1fr_220px] gap-8 items-center">
    ...
    <div className="text-left">
      ...
      <p className="mt-3 text-earth-100 text-sm max-w-2xl leading-relaxed">
        AgriConnect is a farmer-first digital platform created to help farmers
        post agricultural problems, connect with experts, explore market guidance,
        and make smarter farm decisions.
      </p>

      <p className="mt-4 text-earth-100 text-sm max-w-2xl leading-relaxed">
        This website is made by <strong>Geeks of Gurukul</strong>, a modern
        education and technology platform focused on AI/ML, Web3, Robotics,
        Drone Technology, AR/VR, and future-ready technical programs.
      </p>
    </div>

    {/* Right Side Logo */}
    <div className="flex justify-center md:justify-end">
      <div className="w-40 h-40 rounded-3xl bg-white p-5 shadow-2xl border border-white/30">
        <img
          src={gogLogo}
          ...
          <div className="p-10 space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-earth-600 leading-relaxed">
                AgriConnect is built to empower small farmers by giving them a trusted
                place to share crop issues, receive agronomist advice, and connect with
                the right farming support network.
              </p>

              <p className="text-earth-600 leading-relaxed">
                This website is made by <strong>Geeks of Gurukul</strong>, India's
                modern education and technology platform focused on AI/ML, Web3,
                Robotics, Drone Technology, AR/VR, and future-ready technical programs.
                Through this platform, Geeks of Gurukul aims to bring technology-driven
                solutions closer to farmers and rural communities.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-br from-green-50 to-emerald-50 border border-leaf-100 rounded-3xl p-8">
              <div className="flex flex-col md:flex-row gap-6 md:items-center">
                ...
                <div>
                  ...
                  <p className="text-earth-600 leading-relaxed">
                    Geeks of Gurukul is known for delivering futuristic education and
                    technology programs in AI, ML, Web3, Robotics, Drone Technology,
                    AR/VR, and more. AgriConnect reflects the same mission — using
                    technology to solve real-world problems and create impact.
                  </p>
            ...
            <section className="bg-leaf-50 border border-leaf-100 rounded-3xl p-8">
              ...
              <p className="text-earth-600 leading-relaxed">
                We want every farmer to feel supported and connected. AgriConnect
                brings expert help, market access, and practical digital tools to
                farming communities across India. With Geeks of Gurukul's technology
                vision, this platform is designed to make agricultural support more
                accessible, modern, and useful.
              </p>
            </section>
            ...
            <section className="bg-earth-900 text-white rounded-3xl p-8">
              ...
              <p className="text-earth-100 leading-relaxed">
                Geeks of Gurukul is a futuristic education and technology ecosystem
                offering programs in AI/ML, Web3, Medical Technology, Drone Technology,
                Robotics, AR/VR, and other emerging fields. The organization works with
                mentors, institutes, universities, and innovation communities to build
              ...
              <div className="grid sm:grid-cols-2 gap-4 mt-6">
                <div className="rounded-2xl bg-white/10 border border-white/10 p-4">
                  ...
                  <p className="text-earth-100 text-sm mt-1">
                    Building future-ready digital solutions for education and society.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white/10 border border-white/10 p-4">
                  ...
                  <p className="text-earth-100 text-sm mt-1">
                    Bringing expert guidance and digital access to farming communities.
                  </p>
                </div>
              </div>
            </section>
